...
CREATE TABLE "new_AutomationAgent" (
    ...
    "role" TEXT NOT NULL,
    "pipelineType" TEXT NOT NULL DEFAULT 'news',
...
INSERT INTO "new_AutomationAgent" ("active", "createdAt", "description", "id", "isCritical", "lastRun", "lastStatus", "maxRetry", "maxTokens", "model", "name", "order", "platformSlug", "promptVersion", "role", "runCount", "slug", "systemPrompt", "temperature", "timeout", "totalCost", "totalTokens", "updatedAt", "userPromptTmpl") SELECT "active", "createdAt", "description", "id", "isCritical", "lastRun", "lastStatus", "maxRetry", "maxTokens", "model", "name", "order", "platformSlug", "promptVersion", "role", "runCount", "slug", "systemPrompt", "temperature", "timeout", "totalCost", "totalTokens", "updatedAt", "userPromptTmpl" FROM "AutomationAgent";
